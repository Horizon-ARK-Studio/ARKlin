...
_No bugs caught yet. ARKlin has no compiled output to break yet — this file starts filling in once Phase 0/1 of the roadmap in `PROBLEM-STATEMENT.md` produces its first executable `.class` file._
